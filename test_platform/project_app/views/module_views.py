...
def module_manage(request):
    ...
    return render(request, "project_app/module_manage.html",{"user":username,"modules":module_all,"type":"list"})
...
def add_module(request):
    ...
    return render(request,"project_app/module_manage.html",{'form':form,'type':'add'})
...
def edit_module(request,mid):
    ...
    return render(request, "project_app/module_manage.html", {'form': form, 'type': 'edit'})
